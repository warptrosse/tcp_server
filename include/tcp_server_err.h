...
typedef enum tcps_err {
    ...
    TCPS_ERR_BIND_LISTEN_SOCKET,      /**< Could not bind listen socket to
    ...
    TCPS_ERR_SMEM_ATTR_CREATE,        /**< Could not create pthread mutex
                                         attribute. */
    TCPS_ERR_SMEM_ATTR_SET,           /**< Could not set pthread mutex
                                         attribute as shared. */
    TCPS_ERR_SMEM_MUTEX_INIT,         /**< Could not initialize pthread
                                         mutex. */
    ...
    TCPS_ERR_POOL_SMEM_MAP_CREATE,    /**< Could not create share memory
                                         mapping. */
    TCPS_ERR_POOL_SMEM_ATTR_CREATE,   /**< Could not create pthread rwlock
                                         attribute. */
    TCPS_ERR_POOL_SMEM_ATTR_SET,      /**< Could not set pthread rwlock
                                         attribute as shared. */
    TCPS_ERR_POOL_SMEM_RWLOCK_INIT,   /**< Could not initialize pthread
                                         rwlock. */
    TCPS_ERR_POOL_SMEM_RWLOCK_LOCK,   /**< Could not lock processes controller
                                         rwlock. */
    TCPS_ERR_POOL_SMEM_RWLOCK_UNLOCK, /**< Could not unlock processes controller
                                         rwlock. */
